...
func NewService(maxSize int64, timeout time.Duration) *Service {
	return &Service{
...
func (s *Service) buildFileInfo(body io.ReadCloser, contentLength int64, rawURL string) (*downloadDomain.FileInfo, error) {
	...
	return &downloadDomain.FileInfo{
