...
func RegisterRoutes(router fiber.Router, service *downloadUseCases.Service) {
...
func handleDownload(service *downloadUseCases.Service) fiber.Handler {
...
func setResponseHeaders(c fiber.Ctx, info *downloadDomain.FileInfo) {
