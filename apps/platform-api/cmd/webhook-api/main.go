...
func main() {
	...
	app, err := bootstrap.NewWebhookAPI(core, cfg)
	if err != nil {
		slog.Error("failed to bootstrap webhook-api", "error", err)
		os.Exit(1)
	}
	...
	app.WebhooksModule.Register(fiberApp)
