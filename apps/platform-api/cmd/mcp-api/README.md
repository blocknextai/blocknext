...
- common, account, organizations, web3, oauth, plans
- nodeengine, platform, credentials
- payments, subscriptions, quota, apikeys
- mcp
...
- Shutdown via `bootstrap.ListenAndWait` (Fiber + metrics + core).
