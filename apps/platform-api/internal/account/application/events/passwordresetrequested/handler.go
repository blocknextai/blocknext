package passwordresetrequested
...
func (h *Handler) Handle(ctx context.Context, event accountDomainEmails.PasswordResetRequestedDomainEvent) error {
	return h.mailer.SendPasswordReset(ctx, event.Email, event.Token)
}
