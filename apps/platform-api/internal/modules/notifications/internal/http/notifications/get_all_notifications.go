...
func NewGetAllUserNotificationsHandler(service *notificationrecipientsUseCases.Service) fiber.Handler {
	return func(c fiber.Ctx) error {
		...
		result, err := service.GetAllNotifications(c.RequestCtx(), &notificationrecipientsUseCases.GetAllNotificationsQuery{
			UserID:         userID,
			OrganizationID: nil,
...
func NewGetAllOrganizationNotificationsHandler(service *notificationrecipientsUseCases.Service) fiber.Handler {
	return func(c fiber.Ctx) error {
