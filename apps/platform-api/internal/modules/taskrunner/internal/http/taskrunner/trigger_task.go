...
func NewTriggerTaskHandler(service *tasksUseCases.Service) fiber.Handler {
	return func(c fiber.Ctx) error {
		...
		result, err := service.TriggerTask(c.RequestCtx(), &tasksUseCases.TriggerTaskCommand{
...
func NewTriggerTaskWithAPIWorkflowHandler(service *tasksUseCases.Service) fiber.Handler {
	return func(c fiber.Ctx) error {
