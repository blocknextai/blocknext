...
func (e *TaskExecutor) buildTask(ctx context.Context, taskExecution *executionsContract.TaskExecution, envelope taskRunnerDomainTask.TaskEnvelope) (*taskRunnerDomainTask.Task, error) {
