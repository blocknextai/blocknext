...
var (
	ErrTaskExecutionTimeLimit   = apperror.Internal("task exceeded its execution time limit")
	ErrBranchOutputsUnavailable = apperror.Internal("branch outputs are no longer available")
