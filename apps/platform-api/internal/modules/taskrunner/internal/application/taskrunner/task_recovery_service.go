...
func (s *TaskRecoveryService) recoverSingleTask(ctx context.Context, taskExecution *executionsContract.TaskExecution) {
...
func (s *TaskRecoveryService) hasIncompleteNodes(ctx context.Context, taskExecution *executionsContract.TaskExecution) bool {
...
func (s *TaskRecoveryService) determineTaskFinalState(ctx context.Context, taskExecution *executionsContract.TaskExecution) {
	nodeExecutions, err := s.nodeExecutionService.GetAllByTaskID(ctx, taskExecution.ID)
	if err != nil {
...
func (s *TaskRecoveryService) markTaskAsFailed(ctx context.Context, taskExecution *executionsContract.TaskExecution, errorMessage string) {
...
func (s *TaskRecoveryService) markTaskAsSuccess(ctx context.Context, taskExecution *executionsContract.TaskExecution) {
	err := s.taskExecutionService.Update(
		ctx,
		taskExecution.ID,
		taskExecution.OrganizationID,
...
func (s *TaskRecoveryService) reconcileSchedules(ctx context.Context) {
	...
	for _, trigger := range triggers {
		if trigger.Type != triggersContract.TriggerTypeSchedule || trigger.CronPattern == nil {
			continue
		}
...
func (s *TaskRecoveryService) buildScheduleJob(trigger *triggersContract.Trigger) func() {
	return func() {
