...
func (s *credentialOAuthTokenRegenerateService) resolvePlatformCredentialData(credentialInfo *credentialsContract.CredentialInfo) (map[string]any, error) {
...
func (s *credentialOAuthTokenRegenerateService) regenerateOAuth2Token(
	...
	credentialInfo *credentialsContract.CredentialInfo,
...
func (s *credentialOAuthTokenRegenerateService) parseCredentialData(credentialInfo *credentialsContract.CredentialInfo) (commonDomainOAuth2.Credential, bool, error) {
