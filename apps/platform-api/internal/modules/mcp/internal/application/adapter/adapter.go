...
var (
	...
	ErrOrganizationOwnerRequired = apperror.Forbidden("mcp tools require an organization scoped credential")
...
type Adapter interface {
	Build(server nodeengineContract.ServerManager) (*mcpsdk.Server, error)
}
...
func (a *adapter) Build(server nodeengineContract.ServerManager) (*mcpsdk.Server, error) {
...
func (a *adapter) buildHandler(
	nodeID string,
	executor nodeengineContract.ExecutorManager,
